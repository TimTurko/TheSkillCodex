...
- [ ] **Captures C29 en attente (10)** — à récolter par Tim : datasheet L298N ×6 + face avant GBF + trame PulseView (11/06), **IDE Arduino annoté** pour la fiche `ide`, **photo Arduino + shield empilés** pour la fiche `shield` (12/06, mentions inline posées).
