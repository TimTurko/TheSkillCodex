...
GUIDE DU TEMPLATE
=================
- NE PAS mettre de H1 dans le corps : Quartz le génère depuis `title` ci-dessus.
- Premier paragraphe = définition de la notion (1 à 3 phrases, autoportantes,
  sans jargon non défini). C'est ce qui apparaîtra en POPOVER au survol.
- Les sections ci-dessous sont des SUGGESTIONS. Garder uniquement celles
...
<!-- ## Exemple -->
<!-- Cas concret tiré d'un projet type. Préférer un exemple court et clair. -->

<!-- ## Cas particuliers -->
<!-- Variantes, exceptions, nuances. À garder uniquement si pertinent. -->

<!-- ## Pièges -->
<!-- Erreurs fréquentes vues en projet étudiant. Le retour d'expérience est précieux. -->

<!-- ## Aller plus loin -->
<!-- Ressources externes, approfondissements pour les curieux. -->
