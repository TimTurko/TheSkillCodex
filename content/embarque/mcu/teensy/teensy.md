...
- **une seule porte, mais musclée** — tout se programme en API Arduino (`setup()`, `loop()`, `digitalWrite`, `Serial`…) via Teensyduino ; pas d'outillage natif séparé à apprendre, mais un noyau **hand-optimisé par PJRC** qui exploite à fond le matériel ;
...
- [[esp32|ESP32]] · [[stm32|STM32]] — familles voisines (l'ESP32 partage le 3,3 V non tolérant ; le STM32, l'autre voie haute performance)
