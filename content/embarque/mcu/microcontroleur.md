...
![Carte de positionnement des familles de microcontrôleurs selon la puissance de calcul et la connectivité sans fil intégrée — PIC, Arduino et Pico en entrée de gamme sans radio, STM32 et Teensy puissants sans radio, ESP8266 en Wi-Fi, ESP32 et XIAO en Wi-Fi + Bluetooth, Raspberry Pi à part en ordinateur sous Linux.](/ressources/img/microcontroleur-positionnement.svg)
