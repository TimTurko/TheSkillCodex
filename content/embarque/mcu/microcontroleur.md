...
| Raspberry Pi Pico | RP2040, 2× Cortex-M0+ (Pico 2 : RP2350) | MicroPython (Thonny), C/C++ Pico SDK, Arduino-core | veille ~1 mA (carte) | 26 GPIO, PIO (E/S programmables), pas de sans-fil (Pico W : Wi-Fi + BT) | ~4–8 € | apprentissage MicroPython, E/S temps réel (PIO), très bas coût |
