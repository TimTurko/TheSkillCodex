...
La gamme STM32 compte une vingtaine de lignes ; quelques-unes couvrent l'essentiel des besoins d'un projet école. Le **cœur Cortex-M** est le bon repère pour s'orienter : il fixe la classe de performance, le reste est affaire de périphériques.
...
Deux chemins de programmation coexistent — ce sont les **deux portes** d'entrée du STM32.
