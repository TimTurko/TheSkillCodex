...
Sur ce wiki, ces disciplines sont outillées par des parcours techniques dédiés, tandis que le **[[index|parcours projet]]** porte la méthodologie qui les fait converger : le cycle en V, de la [[specification-technique|spécification]] à l'[[integration-et-tests|intégration et tests]].
...
- [[index|Parcours projet (PROJ)]] — la méthodologie du cycle en V
