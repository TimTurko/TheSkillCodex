...
Ce qui caractérise la mécatronique n'est pas la juxtaposition des trois disciplines mais leur **intégration**. La structure mécanique conditionne le choix des actionneurs. Les actionneurs imposent une électronique de puissance. L'électronique fixe les contraintes du [[firmware]]. Enfin, le comportement logiciel doit tenir compte des inerties et des temps de réponse mécaniques. Concevoir mécatronique, c'est arbitrer en permanence à ces frontières plutôt qu'optimiser chaque domaine isolément.
