...
Sur ce wiki, ces disciplines sont outillées par des parcours techniques dédiés, tandis que le **[[conduite/proj/index|parcours projet]]** porte la méthodologie qui les fait converger : le cycle en V, de la [[specification-technique|spécification]] à l'[[integration-et-tests|intégration et tests]].

## Fil rouge

Tout le wiki illustre ces principes sur un même projet : un **bras robotique pédagogique 3 axes**. Trois articulations motorisées (mécanique), leurs drivers et capteurs de position (électronique), la [[machine-a-etats|machine à états]] qui orchestre les mouvements (informatique embarquée) — un système minimal mais complet où les trois disciplines doivent réellement s'accorder.

## Voir aussi

- [[conduite/proj/index|Parcours projet (PROJ)]] — la méthodologie du cycle en V
