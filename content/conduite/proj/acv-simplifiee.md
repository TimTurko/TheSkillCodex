...
L'**ACV simplifiée** (analyse de cycle de vie) est une évaluation de l'impact environnemental d'un produit sur l'ensemble de sa vie — extraction des matières, fabrication, usage, fin de vie — conduite de façon allégée pour **orienter un choix de conception**, sans la rigueur méthodologique d'une ACV normalisée complète.
...
- [[ecoconception|Écoconception]] — la trame qui mobilise et délègue l'ACV
- [[matrice-eco-criteres|Matrice éco-critères]] — l'outil d'arbitrage environnemental intégré aux décisions
- [[integration-et-tests|Intégration et tests]] — où l'ACV réelle sur prototype clôt l'arc écoconception
- **Cours d'ACV / matériaux** (collègues) — méthodologie complète ISO 14040
