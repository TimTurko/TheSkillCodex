...
Pour le projet bras 3 axes, le commanditaire est l'enseignant de mécatronique et l'équipe est à la fois maître d'œuvre et maître d'ouvrage : posture **étudiant-client-de-lui-même** (voir [[relation-client|relation client]]). L'enseignant n'arbitre pas les choix techniques au quotidien — il les valide en revue de phase. L'équipe doit donc s'imposer à elle-même la discipline qu'un client externe lui imposerait : faire des choix défendables, les tracer, les tenir.
